...
export function VideoInputForm(props: VideoInputFormProps) {
    ...
    // variavel seja recarregada somente se houver mudança
    ...
    return (
        <form onSubmit={handleVideoUpload} className='space-y-6'>
            <label htmlFor="video" className='relative border flex rounded-md aspect-video cursor-pointer border-dashed text-sm flex-col gap-2 items-center justify-center text-muted-foreground hover:bg-emerald-700/40'>
                {previewURL ? (
