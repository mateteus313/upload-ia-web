    ...
    <div className='min-h-screen flex flex-col'>
      <div className="px-6 py-3 flex items-center justify-between border-b">
        ...
        <div className="flex items-center gap-3">
          <span className="text-sm text-muted-foreground">NLW IA Trilha Mastery da Rocketseat</span>
      ...
      <main className='flex-1 p-6 flex gap-6'>
        <div className='flex flex-col flex-1 gap-4'>
          ...
          <p className='text-sm text-muted-foreground'>
            Lembrete: pode-se utilizar a variável <code className='text-green-700'>{'{transcription}'}</code> no prompt para adicionar o conteúdo da transcrição do vídeo selecionado.
          </p>
        </div>
        
        <aside className='w-80 space-y-6'>
          <form className='space-y-6'>
            <label htmlFor="video" className='border flex rounded-md aspect-video cursor-pointer border-dashed text-sm flex-col gap-2 items-center justify-center text-muted-foreground hover:bg-emerald-700/40'>
            ...
            <Button type='submit' className='w-full'>
              Carregar vídeo
              <Upload className='w-4 h-3 mal-2'/>
            </Button>
          </form>
